...
public class NewThreadActivity extends AppCompatActivity {
    ...
    UserAccountSettings mUserAccountSettings;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSubtitle = (EditText) this.findViewById((R.id.subtitle));
    ...
    private void setNewThreadWidgets(UserSettings userSettings){

        UserAccountSettings settings = userSettings.getSettings();
        UniversalImageLoader.setImage(settings.getProfile_photo(), mProfilePhoto, null, "");
        mRootName.setText(settings.getCurrent_root());
    ...
    private void setupFirebaseAuth(){
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                setNewThreadWidgets(mFirebaseMethods.getUserSettings(dataSnapshot));
